...
- 通过模块化组件按需组合，既可建设双节点实验环境，也可扩展到大规模生产云；
...
openEuler社区版本分为长期支持版本和创新版本。openEuler 24.03 LTS SP3于 **2025年12月30日** 发布，基于Linux Kernel 6.6，面向服务器、云和AI工作负载，并支持UnifiedBus SuperPoD相关能力。官方社区下载页列出的架构包括x86_64、AArch64、ARM32、LoongArch64和RISC-V，计划生命周期终点为2027年12月。[来源：openEuler社区版本下载页](https://www.openeuler.org/zh/download/)

截至2026年7月31日，24.03 LTS系列已有SP4于2026年6月30日发布。因此，教材不应把SP3表述为“当前最新服务包”；准确说法是：**本书实训选定的长期支持系列固定版本为openEuler 24.03 LTS SP3。** 固定SP3有利于保持软件包依赖、配置文件路径、内核和实验截图一致，而概论部分仍应说明同系列已继续演进。
...
4. 工业和信息化部，《算力互联互通行动计划》，2025年6月27日发布（文件成文日期为2025年5月21日）。https://fjca.miit.gov.cn/zwgk/zcwj/wjfb/art/2025/art_25eea57dd6f840e680184fffb086883d.html
