...
| 图3.8 Antelope实验环境Horizon登录与项目概览 | **本地真实截图并脱敏；官方素材后备** | 展示登录入口和项目概览，不显示账号、令牌、Cookie、UUID及无关桌面区域 | [Horizon 2026.1](https://docs.openstack.org/horizon/2026.1/)、[Horizon 用户文档](https://docs.openstack.org/horizon/2026.1/user/) |
