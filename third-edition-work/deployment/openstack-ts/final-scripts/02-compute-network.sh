...
# Configure the compute management NIC and basic hostname/hosts mapping.
# Run this script on the compute node only.

MGMT_NIC="ens33"
COMPUTE_IP="192.168.234.150/24"
GATEWAY_IP="192.168.234.2"
DNS_IP="192.168.234.2"

nmcli connection modify "${MGMT_NIC}" \
  ipv4.addresses "${COMPUTE_IP}" \
